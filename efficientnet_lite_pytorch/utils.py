...
GlobalParams = collections.namedtuple('GlobalParams', [
    ...
    'relu_fn', 'fix_head_stem',  'local_pooling', 'use_se'])
...
def round_filters(filters, global_params, skip=False):
    ...
    if skip or not multiplier:
        # print( 'round_filters fix_head_stem: ', filters, skip )
        return filters
...
def efficientnet_params(model_name):
    ...
    params_dict.update( {
        # from efficientnet/lite/efficientnet_lite_builder.py
...
def efficientnet_lite(width_coefficient=None, depth_coefficient=None, image_size=None,
                      dropout_rate=0.2, drop_connect_rate=0.2, num_classes=1000):
    ...
    global_params = GlobalParams(
        ...
        min_depth=None,
        # for lite0-4
        relu_fn='relu6',  # Relu6 is for easier quantization.
        fix_head_stem=True,  # Don't scale stem and head.
        local_pooling=False, # ?????????  # special cases for tflite issues.
